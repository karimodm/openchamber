...
- Selecting a JSON summary, tree, or raw view saves that mode as a client-wide preference. New and refreshed JSON tool outputs read the saved mode across sessions and embedded chat frames; missing or invalid preferences use Summary.
